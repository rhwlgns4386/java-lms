...
public class SessionImageRepositoryTest {
    ...
    void crud() {
        ...
        image.toSession(new Session(1L, (List<SessionImage>) null, new SessionPeriod("20250101", "20250301"), new SessionType(), SessionStatus.ofInitInstance(), LocalDateTime.now(), null));

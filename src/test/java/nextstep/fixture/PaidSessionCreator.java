...
public class PaidSessionCreator {
    ...
    public static PaidSession status(SessionStatus status) {
        return new PaidSession(1L, SessionDateCreator.standard(), si1, status, new ArrayList<>(), 80, 25000);
    }

    public static PaidSession capacity(List<Long> student, int maxNumOfStudents) {
        return new PaidSession(1L, SessionDateCreator.standard(), si1, RECRUITING, student, maxNumOfStudents, 25000);
    }

    public static PaidSession fee(int sessionFee) {
        return new PaidSession(1L, SessionDateCreator.standard(), si1, RECRUITING, new ArrayList<>(), 80, sessionFee);
    }

    public static PaidSession user(Long userId) {
        return new PaidSession(1L, SessionDateCreator.standard(), si1, RECRUITING, List.of(userId), 80, 25000);
    }
}

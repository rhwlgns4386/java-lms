...
class CourseSessionRepositoryTest {
    ...
    void setUp() {
        ...
        jdbcTemplate.update("INSERT INTO session (id, progress_status, recruitment_status, start_date, end_date,  session_type) VALUES (?, 'READY', 'RECRUITING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'FREE')", sessionId1);
        jdbcTemplate.update("INSERT INTO session (id, progress_status, recruitment_status, start_date, end_date,  session_type) VALUES (?, 'READY', 'RECRUITING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'FREE')", sessionId2);
    }

...
public class SessionInfoTest {
    public final static SessionInfo SESSION_INFO_RECRUIT_READY = new SessionInfo(new SessionMetaData("모집중_준비중", "작성자1"),
            ...
            StateCode.RECRUITING, ProgressCode.READY);

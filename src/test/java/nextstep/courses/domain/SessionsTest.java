...
class SessionsTest {
    ...
    void create() {
        List<Session> sessionList = List.of(
            SessionTestFixture.createPaidSession(1L, 3000L, 3, SessionStatus.PREPARE, RegisterStatus.REGISTER),
    ...
    void get_session_with_session_id() {
        ...
        assertThat(session).isEqualTo(SessionTestFixture.createFreeSession(2L, SessionStatus.PREPARE, RegisterStatus.REGISTER));
    }
}

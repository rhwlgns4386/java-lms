...
class SessionTest {
    ...
    void register() {
        ...
        Session firstCourse = new Session(SessionStatus.READY, new SessionPeriod(startDate,endDate));
        assertThatThrownBy(firstCourse::register)
                .isInstanceOf(IllegalArgumentException.class);

        Session secondCourse = new Session(SessionStatus.CLOSED, new SessionPeriod(startDate,endDate));

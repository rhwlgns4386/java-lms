...
public class TestEnrollmentsFactory {
    ...
    public static Enrollments enrollments(SessionStatus sessionStatus, Set<EnrollmentStudent> enrolledStudents) {
    ...
    public static Enrollments limitEnrollments(int capacity, SessionStatus sessionStatus, Session session,
                                               Set<NsUser> users) {
        return new LimitedEnrollments(capacity, new Charge(0), sessionStatus, toStudentSet(session, users));
    }

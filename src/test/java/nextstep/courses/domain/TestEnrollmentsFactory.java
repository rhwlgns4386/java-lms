...
public class TestEnrollmentsFactory {
    ...
    static DefaultEnrollments enrollments(SessionStatus sessionStatus, Session session) {
        return enrollments(sessionStatus, session, Set.of());
    }

    public static DefaultEnrollments enrollments(SessionStatus sessionStatus, Session session,
                                                 Set<NsUser> enrolledStudents) {
        return new DefaultEnrollments(sessionStatus, toStudentSet(session, enrolledStudents));
    }

    public static DefaultEnrollments limitEnrollments(int capacity, SessionStatus sessionStatus, Session session,
                                                      Set<NsUser> users) {

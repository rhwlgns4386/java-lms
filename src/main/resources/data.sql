...
INSERT INTO course (id,title, creator_id, created_at) values (1, 'TDD CleanCode With Java','1' , CURRENT_TIMESTAMP());
-- INSERT INTO ns_session(id, start_date, end_date,status_code, type_code, maximum_number_of_applicants, fee_amount,created_at) values (1,'20250101', '20250301', '02', '01', 5, 220000, CURRENT_TIMESTAMP());

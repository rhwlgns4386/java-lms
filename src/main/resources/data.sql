...
INSERT INTO session (price, session_price_type, session_status, start_date_time, end_date_time) VALUES (2000, 'PAID', 'ENROLLING', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());

INSERT INTO session_cover_image (session_id, filename, volume, extension, height, width, file_path) VALUES(1, 'leo.png', 150, 'png', 300, 200, '/home/lms/image/cover/leo.png');

INSERT INTO enroll_user_info (session_id, user_id) VALUES (1, 1);
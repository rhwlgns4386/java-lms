...
INSERT INTO ns_user (id, user_id, password, name, email, created_at) values (3, 'gyeongjae', 'test', '경재', 'testtest@slipp.net', CURRENT_TIMESTAMP());
...
INSERT INTO session (id, course_id, price, status, start_at, end_at, byte_size, width, height, extension, type, max_student_size)
VALUES (1, 1, 3000, 'register', current_timestamp, current_timestamp, 1, 300, 200, 'png', 'paid', 5);

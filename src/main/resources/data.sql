...
INSERT INTO ns_user (id, user_id, password, name, email, created_at) values (3, 'joonbyeong', 'test', '김준이', 'joonkb@slipp.net', CURRENT_TIMESTAMP());
...
INSERT INTO session (id, title, session_type, price, max_enrollment, started_at, ended_at) values (4, '스프링 핵심원리', 'PAID', 100000, 20, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());

INSERT INTO session_enrollment (user_id, session_id) values (3, 4);

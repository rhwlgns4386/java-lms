INSERT INTO ns_user (id, user_id, type, password, name, email, created_at)
values (1, 'javajigi', 'student', 'test', '자바지기', 'javajigi@slipp.net', CURRENT_TIMESTAMP());
INSERT INTO ns_user (id, user_id, type, password, name, email, created_at)
values (2, 'sanjigi', 'student', 'test', '산지기', 'sanjigi@slipp.net', CURRENT_TIMESTAMP());
INSERT INTO ns_user (id, user_id, type, password, name, email, created_at)
values (3, 'pythonjigi', 'lecturer', 'test', '파이썬지기', 'pythonjigi@slipp.net', CURRENT_TIMESTAMP());

...
import nextstep.courses.factory.Session2Factory;
import nextstep.courses.factory.SessionPeriodConverter;
import org.springframework.jdbc.core.JdbcTemplate;
import org.springframework.jdbc.core.RowMapper;

public class JdbcSession2Dao {
    private final JdbcTemplate jdbcTemplate;

    public JdbcSession2Dao(JdbcTemplate jdbcTemplate) {
    ...
    public final Optional<Session> findById(Long id, List<CoverImage> coverImages) {
        ...
        RowMapper<Session> rowMapper = ((rs, rowNum) -> Session2Factory.session(
                rs.getLong(1),
                rs.getInt(2),
